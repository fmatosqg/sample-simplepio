...
adb -s Android.local shell pm uninstall com.example.androidthings.simplepio.debug
...
adb -s Android.local shell am start -n com.example.androidthings.simplepio.debug/.BlinkActivity